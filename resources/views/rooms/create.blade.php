    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form action="{{ route('boarding-houses.rooms.store', $boardingHouse) }}" method="POST"
                        enctype="multipart/form-data" x-data="imagePreview()">
                        @csrf
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="type_name" class="block mt-1 w-full" type="text" name="type_name"
                                :value="old('type_name')" required autofocus
                            ...
                            <p class="mt-1 text-sm text-luxury-600 dark:text-luxury-400">
                                Give a name to identify this room type
                            </p>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <x-text-input id="price_per_month" class="block mt-1 w-full" type="number"
                                    name="price_per_month" :value="old('price_per_month')" required min="0"
                                    placeholder="1500000" />
                            ...
                            <div>
                                ...
                                <x-text-input id="availability" class="block mt-1 w-full" type="number"
                                    name="availability" :value="old('availability')" required min="1" placeholder="5" />
                        ...
                        <div class="mb-6">
                            ...
                            <x-text-input id="size" class="block mt-1 w-full" type="text" name="size"
                                :value="old('size')" placeholder="e.g. 3x4 meters, 12 m²" />
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="description" name="description" rows="3"
                                ...
                                placeholder="Additional details about this room type...">{{ old('description') }}</textarea>
                        ...
                        <div class="mb-6">
                            ...
                            <p class="mt-2 text-sm text-luxury-600 dark:text-luxury-400">
                                Select facilities available in this room type
                            </p>
                        </div>
